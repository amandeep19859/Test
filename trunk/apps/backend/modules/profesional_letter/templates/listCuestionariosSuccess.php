    ...
    <div id="sf_admin_content">
        <div class="sf_admin_list">
            ...
            <ul class='alerta_cuestionario'>
                ...
                <?php include_partial('empresa/tableCuestionarios', array('respuesta' => $respuesta)); ?>
                <?php endforeach ?>
            </ul>
            ...
            <ul class='sf_admin_actions'>
                    <li class='sf_admin_action_list'><a href='<?php echo url_for('empresa')?>'>Volver al Listado</a></li>
                </ul>
        </div>
    </div>
</div>