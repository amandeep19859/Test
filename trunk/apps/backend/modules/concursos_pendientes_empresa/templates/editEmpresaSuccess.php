...
<div id="sf_admin_container">
    ...
    <div id="sf_admin_content">
        <div class="sf_admin_form">
            <form method="post" action="/backend.php/concursos_pendientes_empresa/editEmpresa/id/<?php echo $id ?>" enctype="multipart/form-data">
                ...
                <ul class="sf_admin_actions" style="margin: 10px 10px 10px 0 !important;">
                    <li class="sf_admin_action_list">
                        <a href="/backend.php/concursos_pendientes_empresa">Volver al Listado</a>
                    </li>
...
foreach (StatesTable::getCiudadesAutonomas() as $city)
    ...
    $(document).ready(function() {
        ...
        //$("#concurso_googlemap_map").attr("style", "width:auto");
    });
