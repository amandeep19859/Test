...
<div id="sf_admin_container">
    <div id="sf_admin_content">
        ...
        <div class="sf_admin_list">
            ...
            <ul class='destacados'>
                <li><?php echo print_boolean_ok($producto->isDestacadoPorTipo()) ?><span class='title'>Destacado por tipo - <b><?php echo $producto->getTresProduct() ?></b></span>
                    ...
                    <ul class='sortable'
                        id='destacado_<?php echo $producto->hasActividad() ? 'producto_tipo_tres' : 'producto_tipo_dos' ?>_<?php echo $producto->getTipoId() ?>'>
                            <?php foreach ($producto->getDestacadosPorTipo() as $destacado) : ?>
                            <li id='producto_<?php echo $destacado->getProducto()->getId() ?>'
                                class='ui-state-default'><?php echo $destacado->getProducto()->getNombreCompleto() ?>
                                <!--span
                                    class='edit_action'><a
                                        href='<?php echo url_for('producto_show_destacados', array('id' => $destacado->getProducto()->getId())) ?>'>Editar</a></span-->
                            </li>
                        <?php endforeach ?>
                    </ul>
                ...
                <li><?php echo print_boolean_ok($producto->isDestacadoPorMarca()) ?>
                    <span class='title'>Destacado por marca - <b><?php echo $producto->getMarca() ?></b></span>
                ...
                <li><?php echo print_boolean_ok($producto->isDestacadoPorProducto()) ?>
                    <span class='title'>Destacado por producto - <b><?php echo $producto ?></b></span>
                    <span class='action_destacado'>
                        <a
                    ...
                    <ul class='sortable' id='destacado_nombre_%<?php echo $producto->getName() ?>%'>
                ...
                <li><?php echo print_boolean_ok($producto->isDestacadoPorMarcaAndTipo()) ?>
                    <span class='title'>Destacado por marca - <b><?php echo $producto->getMarca() ?>
                            para tipo de producto <?php echo $producto->getTresProduct() ?></b></span>
                    <span class='action_destacado'>
        ...
        <ul class='sf_admin_actions'>
            <li class='sf_admin_action_list'><?php echo link_to('Volver a productos', 'producto_lista_blanca', array('class' => 'sf_admin_action_cancel')) ?></li>
