...
<div id="content" style="padding-top: 20px !important;">
    <p class="left_ic" style="margin-bottom: 0px;"><strong>DESCRIPCIÓN DE LA INCIDENCIA</strong></p>
    <span class="producto_comment"><?php echo html_entity_decode($concurso->incidencia) ?></span>
</div>
...
<style type="text/css">
    ...
    .left_ic{background: url("/images/img_nosotros/circulo-lista-2.png") no-repeat scroll left top transparent;
             ...
             padding-left: 20px; }
    .producto_comment{ font-family: Trebuchet MS; font-size: 14px; font-weight: normal !important; float: left; margin: 14px 0 0 20px;}
