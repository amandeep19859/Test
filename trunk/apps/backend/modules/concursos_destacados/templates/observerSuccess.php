...
<span>Indica a continuación el beneficio total que se repartirá entre los ganadores del concurso</span>
...
<?php endforeach;?>
        ...
        <form action="<?php echo url_for('concursos_destacados/observed?concurso_id='.$concurso->id)?>"	method="post">
