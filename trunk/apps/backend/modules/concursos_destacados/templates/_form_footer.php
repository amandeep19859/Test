...
<script language="javascript">
  ...
  if ($("#concurso_Empresa_Entidad_empresa_sector_uno_id").length > 0) {
      reorder_combobox('concurso_Empresa_Entidad_empresa_sector_uno_id', 'ids_ordenados_concurso_empresa_sector_uno');
  }
  if ($('#concurso_Empresa_Entidad_empresa_sector_uno_id option:selected').val()>0) {
      reorder_combobox('concurso_Empresa_Entidad_empresa_sector_dos_id', 'ids_ordenados_concurso_empresa_sector_dos?empresa_sector_uno_id='+$('#concurso_Empresa_Entidad_empresa_sector_uno_id option:selected').val());
  }
  if ($('#concurso_Empresa_Entidad_empresa_sector_dos_id option:selected').val()>0) {
      reorder_combobox('concurso_Empresa_Entidad_empresa_sector_tres_id', 'ids_ordenados_concurso_empresa_sector_tres?empresa_sector_dos_id='+$('#concurso_Empresa_Entidad_empresa_sector_dos_id option:selected').val());
  }
  ...
  $("#concurso_Empresa_Entidad_empresa_sector_uno_id").change(function(){
      if ($('#concurso_Empresa_Entidad_empresa_sector_uno_id option:selected').val()>0) {
          reorder_combobox('concurso_Empresa_Entidad_empresa_sector_dos_id', 'ids_ordenados_concurso_empresa_sector_dos?empresa_sector_uno_id='+$('#concurso_Empresa_Entidad_empresa_sector_uno_id option:selected').val());
      }
  });
  $("#concurso_Empresa_Entidad_empresa_sector_dos_id").change(function(){
      if ($('#concurso_Empresa_Entidad_empresa_sector_dos_id option:selected').val()>0) {
          reorder_combobox('concurso_Empresa_Entidad_empresa_sector_tres_id', 'ids_ordenados_concurso_empresa_sector_tres?empresa_sector_dos_id='+$('#concurso_Empresa_Entidad_empresa_sector_dos_id option:selected').val());
      }
  });
