<div id="content" style="padding-top: 30px !important;">
    <?php if ($concurso->ConcursoTipo->id == 1): ?>
        ...
        <?php if ((($concurso->States->name != "Toda España" && $concurso->Empresa->getRoadTypeId()) || ($concurso->States->name == "Toda España" && $concurso->Empresa->getRoadTypeId())) && !empty($concurso->Empresa->RoadType->name)): ?>
        ...
        <?php endif; ?>
        <?php if ($concurso->getCpMunicipioProvinciaCongi()) : ?>
            <p class="left_ic"><strong>Localidad: </strong>
                <span class="com_localidad"><?php echo $concurso->getCpMunicipioProvinciaCongi(); ?></span></p>
        <?php endif; ?>
...
<div id="content" style="padding-top: 20px !important;">
    ...
    <span class="empresa_comment"><?php echo html_entity_decode($contribucion->resumen) ?></p></span>
</div>
