<ul id="submenu_concursos">
  <li>
    <?php echo link_to(__('Empresa/Entidad'), url_for('company_case_study'), array('title' => __('Casos de empresa/entidad'))); ?>
  </li>
  <li>
    <?php echo link_to(__('Producto'), url_for('product_case_study'), array('title' => __('Casos de product'))); ?>
  </li>
</ul>
