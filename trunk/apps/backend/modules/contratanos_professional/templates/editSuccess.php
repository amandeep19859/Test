...
<div id="sf_admin_container">
    <h1><?php echo __('Editar formulario  Contrátanos de Profesional', array(), 'messages') ?></h1>
    ...
    function ceuta_melilla(f,g){
        var state2city = new Array();<?php foreach (StatesTable::getCiudadesAutonomas() as $city)
            ...
            ?>
                ...
                //$("#editContratanosForm").bind("submit",function(){$("#contratanos_city_id").removeAttr("disabled");});
