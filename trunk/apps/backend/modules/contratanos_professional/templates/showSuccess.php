...
<div id="sf_admin_container">
    <h1>Detalle del formulario Contrátanos para Profesional</h1>
    ...
    <div id="sf_admin_content">
        ...
        <ul class="dragbox-content">
            <li>
                ...
                <?php echo date('d/m/Y', strtotime($contratanos->getCreatedAt())); ?></span>
            </li>
            <li>
            ...
            <?php  if($contratanos->getEmpresa()): ?>
            <li>
                <span class="bold"><?php echo __('Empresa/Entidad: ') ?></span>
                <?php echo $contratanos->getEmpresa() ?>
            </li>
            <?php endif; ?>
            <li>
            ...
            <br/>
            <li style="margin: 0" class="comentario">
                <span class="bold"><?php echo __('Comentario:') ?></span>
                <p class="mr-span"> </p>
                <?php echo html_entity_decode($contratanos->getAyudar()) ?>

                <span class="ver_link">
                    <?php echo '<br/>' . link_to('ver +', 'contratanos_professional/showPlan?id=' . $contratanos->getId(), array("popup" => array("popWindow", "width=650,height=500, left=200, scrollbars=1, menubar=1, scrollbars=1"))) ?>
    ...
    <ul class="sf_admin_actions" style="margin-left: 6px !important; margin-top: 0 !important;">
        <li class="sf_admin_action_list"><a href="<?php echo url_for('contratanos_contratanos_professional') ?>">Volver al Listado</a></li>
    </ul>
</div>
<style type="text/css">
    .comentario ol{margin: 10px 10px 10px 20px !important;}
</style>