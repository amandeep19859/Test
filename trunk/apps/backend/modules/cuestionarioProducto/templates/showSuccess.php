<div id="sf_admin_container">
    <h1><?php echo __('Detalle del cuestionario de auditoría de Producto', array(), 'messages') ?></h1>
    <div id="sf_admin_content">
        ...
        <?php if (!$sf_request->isXmlHttpRequest()) : ?>
            ...
            <ul class='sf_admin_actions' style="margin-left: -2px !important;">
                <li class='sf_admin_list'><a href='<?php echo url_for("cuestionario_producto") ?>'>Volver al Listado</a></li>
            </ul>
        <?php endif ?>
    </div>
</div>
