...
<div id="sf_admin_container">
    ...
    <div id="sf_admin_content">
        <ul class="dragbox-content" >
            ...
            <li class="comment">
                ...
                <span class="ver_link">
                    <?php echo '<br/>' . link_to('ver +', 'user_product_case_study/showDescription?id=' . $product->getId(), array("popup" => array("popWindow", "width=650,height=500, left=200, scrollbars=1, menubar=1"))) ?>
                </span>                
            </li>
    ...
    <ul class='sf_admin_actions'>
        <li class="sf_admin_action_list"><?php echo link_to('Volver al Listado', 'user_product_case_study/index') ?></li>
    </ul>
</div>
<style type="text/css">
    .ver_link {
