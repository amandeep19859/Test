...
<div id="sf_admin_container">
    ...
    <div id="sf_admin_content">
        <div class="sf_admin_form">
            <form method="post" action="/backend.php/concursos_pendientes/editEmpresa/id/<?php echo $id ?>" enctype="multipart/form-data">
                ...
                <fieldset id="sf_fieldset_none">
                    ...
                    $fields_empresa = array(
                        ...
                        'concurso_puerta', 'codigopostal', 'states_id', 'city_id', 'persona_contacto', 'email', 'telefono',
                ...
                <ul class="sf_admin_actions" style="margin-left:0 !important">
    ...
    $(document).ready(function() {
        ...
        $('#concurso_lista').change(function() {
            if ($(this).val() == 'Null') {
                ...
                $('tr:has(th:contains("Auditorías realizadas"))').show()
                $('tr:has(th:contains("Cuestionario asociado"))').show();
                google.maps.event.trigger(document.getElementById("concurso_googlemap_map"), "resize");
            }
            else if ($(this).val() == 'ln') {
                $('tr:has(th:contains("Comentario inicial"))').hide()
                $('tr:has(th:contains("Lista negra: por qué aparece aquí"))').show()
