...
<div id="sf_admin_container">
    ...
    <h1>Detalle de la contribución de Empresa/Entidad</h1>
    ...
    <div id="sf_admin_content">
        ...
        <ul class="dragbox-content">
            ...
            <li><strong>Descripción de la incidencia:</strong> 
                ...
                <?php //echo link_to('descargar pdf', 'contribucion_empresa/Download_pdfIncidencia?id=' . $contribucion->getId())  ?>
            </li>
            ...
            <li><strong>Resumen del Plan de acción:</strong>
                ...
                <span class="ver_link">    
                    <?php echo '<br/>' . link_to('ver +', 'contribucion/showResumen?id=' . $contribucion->getId(), array("popup" => array("popWindow", "width=650,height=500, left=200, scrollbars=1, menubar=1"))) ?>
                </span>
            </li>
            <div style="clear: both; height: 22px;"></div>
