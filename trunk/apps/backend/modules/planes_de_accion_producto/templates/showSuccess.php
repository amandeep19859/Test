...
<h1>Detalle del Plan de acción de Producto</h1>
...
<?php //echo link_to('Volver al Listado','planes_de_accion_producto/index')?>
</div>-->
...
<div id="sf_admin_container">
    ...
    <div id="sf_admin_content">
        ...
        <ul class="dragbox-content">
            ...
            <li><strong>Descripción de la incidencia:</strong> 
                ...
                <span class="ver_link">
                    <?php echo '<br/>' . link_to('ver +', 'planes_de_accion/showIncidenciaDetail?id=' . $contribucion->getId(), array("popup" => array("popWindow", "width=650,height=500, left=200, scrollbars=1, menubar=1"))) ?>
            ...
            <li><strong>Resumen del Plan de acción:</strong>
                ...
                <span class="ver_link">
                    <?php echo '<br/>' . link_to('ver +', 'planes_de_accion/showResumen?id=' . $contribucion->getId(), array("popup" => array("popWindow", "width=650,height=500, left=200, scrollbars=1, menubar=1"))) ?>
                </span>
            </li>
            <div style="clear: both; height: 22px;"></div>
            <li><strong>Plan de acción:</strong> 
                ...
                <span class="ver_link">
                    <?php echo '<br/>' . link_to('ver +', 'planes_de_accion/showPlanAccionDetail?id=' . $contribucion->getId(), array("popup" => array("popWindow", "width=650,height=500, left=200, scrollbars=1, menubar=1"))) ?>
    ...
    <ul class='sf_admin_actions' style="margin-left: 6px !important;">
        <li class='sf_admin_action_list'><?php echo link_to('Volver al Listado', '@contribucion_planes_de_accion_producto', array('class' => 'sf_admin_action_cancel')) ?></li>
    </ul>
