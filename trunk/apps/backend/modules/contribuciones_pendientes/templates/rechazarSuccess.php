...
<div id="sf_admin_container">
    <h1><?php echo __("Sugerir modificaciones a una contribución") ?></h1>
    <form action="<?php echo url_for('contribuciones_pendientes/contacted?contribucion_id=' . $contribucion->id) ?>" method="post">
        ...
        <ul class='sf_admin_actions' style="margin-left: 0px !important;">
            <li class='sf_admin_action_list'><?php echo link_to('Volver al Listado', '@contribuciones_pendientes') ?>
