...
<?php end_slot(); ?>
<?php include_slot('sf_admin.current_header') ?><?php slot('sf_admin.current_header') ?>
<th class="sf_admin_text sf_admin_list_th_concurso_sector" style="width: 350px">
    <span class="block" style="width: 350px">
...
<?php end_slot(); ?>
<?php include_slot('sf_admin.current_header') ?><?php slot('sf_admin.current_header') ?>
<th class="sf_admin_text sf_admin_list_th_concurso_subsector" style="width: 350px">
    <span class="block" style="width: 350px">
...
<?php end_slot(); ?>
<?php include_slot('sf_admin.current_header') ?><?php slot('sf_admin.current_header') ?>
<th class="sf_admin_text sf_admin_list_th_concurso_actividad" style="width: 350px">
    <span class="block" style="width: 350px">
        <?php if (('concurso_id' == $sort[0] && $sf_request->hasParameter("columname") && $sf_request->getParameter("columname") == "actividad") || (isset($sort[2]) && !empty($sort[2]) && $sort[2] == "actividad")): ?>
