<?php
  ...
  $url = sprintf('http://%s/concursos/%s/%s/%s/%s/plan-de-accion/%s',
    $_SERVER['HTTP_HOST'], $concurso->getProducto_or_Empresa_NameSlug(), $concurso->getSlug(),
    $concurso->getDateTimeObject('created_at')->format('d-m-Y'), $concurso->getDateTimeObject('created_at')->format('H:i'),
