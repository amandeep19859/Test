...
<div id="sf_admin_container">
    <h1>Detalle del concurso pendiente de Producto</h1>
    ...
    <div id="sf_admin_content">
        ...
        <ul class="dragbox-content">
            ...
            <?php if ($concurso->getFechaRevision()): ?>
                <li><span class="bold">Fecha de revisión: <?php echo format_datetime($concurso->fecha_revision, "HH:mm dd/MM/y", "es_ES") ?>
                    <?php endif; ?>
                    <?php if ($concurso->getFechaActivacion()): ?>
                        <li><span class="bold">Fecha de activación: <?php echo format_datetime($concurso->fecha_activacion, "HH:mm dd/MM/y", "es_ES") ?>
                        </li>
                    <?php endif; ?>
                    <?php if ($concurso->getFechaReferendum()): ?>
                        <li><span class="bold">Fecha de Referéndum: <?php echo format_datetime($concurso->fecha_referendum, "HH:mm dd/MM/y", "es_ES") ?>
                        </li>
                    <?php endif; ?>
                    <?php if ($concurso->getFechaDeliberacion()): ?>
                        <li><span class="bold">Fecha de Deliberación: <?php echo format_datetime($concurso->fecha_deliberacion, "HH:mm dd/MM/y", "es_ES") ?>
                        </li>
                    <?php endif; ?>
                    <?php if ($concurso->getFechaCerrado()): ?>
                        <li><span class="bold">Fecha cerrado: <?php echo format_datetime($concurso->fecha_cerrado, "HH:mm dd/MM/y", "es_ES") ?>
                        </li>
                    <?php endif; ?>
                    <?php if ($concurso->getFechaRechazado()): ?>
                        <li><span class="bold">Fecha rechazado: <?php echo format_datetime($concurso->fecha_rechazado, "HH:mm dd/MM/y", "es_ES") ?>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if ($concurso->ConcursoTipo->id == 1): ?>
                        ...
                        <?php if ($concurso->Empresa->codigopostal): ?>
                            <li><span class="bold">C.P.</span>: <?php echo $concurso->Empresa->codigopostal ?>
                            </li>
                        <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <br>
                    <li><span class="bold">Descripción de la incidencia</span>: <p class="mr-span"> </p>
                    ...
                    <?php foreach ($concurso->Contribuciones as $contribucion): ?>
                        <div class="concurso_contribucion">
                            ...
                            <ul>
                                ...
                                <li><span class="bold"><?php echo $contribucion->ContribucionEstado->name ?></li>
