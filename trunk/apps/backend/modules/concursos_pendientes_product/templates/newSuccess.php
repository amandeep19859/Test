...
<div id="sf_admin_container">
    <h1><?php echo __('Nuevo concurso', array(), 'messages') ?></h1>

    <?php include_partial('concursos_pendientes_product/flashes') ?>

    <div id="sf_admin_header">
        <?php include_partial('concursos_pendientes_product/form_header', array('concurso' => $concurso, 'form' => $form, 'configuration' => $configuration)) ?>
    </div>

    <div id="sf_admin_content">
        <?php include_partial('concursos_pendientes_product/form', array('concurso' => $concurso, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>

    <div id="sf_admin_footer">
        <?php include_partial('concursos_pendientes_product/form_footer', array('concurso' => $concurso, 'form' => $form, 'configuration' => $configuration)) ?>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        $('.sf_admin_form_field_contribucion').children().children().attr('style', 'font-weight:bold!important');
        $('.sf_admin_form_field_contribucion label:first').html('Contribución');
    ...
    $("#concurso_name").bind('keyup', function() {
        setTimeout(function() {
            if ($("#concurso_name").val() != '') {
                get_producto_name($("#concurso_name").val());
            }
        }, 100);
    });
