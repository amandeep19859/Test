<div id="content" style="padding-top: 30px !important;">
    <?php if ($contribucion->getConcurso()->getConcursoTipoId() == 1): ?>
        ...
        <?php if (($contribucion->getConcurso()->getEmpresa()->getStates() != "Toda España" && $contribucion->getConcurso()->getEmpresa()->getRoadTypeId()) || ($contribucion->getConcurso()->getEmpresa()->getStates() == "Toda España" && $contribucion->getConcurso()->getEmpresa()->getRoadTypeId())): ?>
            <p class="left_ic"><strong>Tipo de vía: </strong><span class="com_trebute"><?php echo $contribucion->getEmpresaRoadType(); ?></span></p>
        <?php endif ?>

        <?php if (($contribucion->getConcurso()->getEmpresa()->getStates() != "Toda España" && $contribucion->getConcurso()->getEmpresa()->getDireccion()) || ($contribucion->getConcurso()->getEmpresa()->getStates() == "Toda España" && $contribucion->getConcurso()->getEmpresa()->getDireccion())): ?>
        ...
        <?php endif; ?>
        <?php if (($contribucion->getConcurso()->getEmpresa()->getStates() != "Toda España" && $contribucion->getConcurso()->getEmpresa()->getNumero()) || ($contribucion->getConcurso()->getEmpresa()->getStates() == "Toda España" && $contribucion->getConcurso()->getEmpresa()->getNumero())): ?>
        ...
        <p class="left_ic"><strong>Localidad: </strong>
            <span class="com_localidad"><?php echo $contribucion->getConcurso()->getEmpresa()->getCpMunicipioProvinciaPlan(); ?></span>
        </p>
...
<div id="content" style="padding-top: 20px !important;">
    <p class="left_ic"><strong>RESUMEN DEL PLAN DE ACCIÓN</strong></p>
    <span class="empresa_comment"><?php echo html_entity_decode($contribucion->resumen) ?></span>
</div>
<style type="text/css">
