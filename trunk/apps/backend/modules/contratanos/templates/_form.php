...
<div class="sf_admin_form">
    <?php echo form_tag_for($form, '@contratanos') ?>
    ...
    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
        <?php include_partial('contratanos/form_fieldset', array('contratanos' => $contratanos, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
    <?php endforeach; ?>

    <?php include_partial('contratanos/form_actions', array('contratanos' => $contratanos, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
</form>
</div>
