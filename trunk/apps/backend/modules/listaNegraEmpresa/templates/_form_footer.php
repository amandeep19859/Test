...
<script type='text/javascript'>
    ...
    $(document).ready(function() {
        sortProvinciaList("empresa_states_id");
        ...
        /*    if($('#empresa_concurso_id option').length <= 1) {
         $('.sf_admin_form_field_concurso_id').hide();
         }
         */
        ...
        //validar googleMap address...
        $('form').submit(function(event) {
            return true;
            //                var validated = true;
            //                if ($('#empresa_lista').val() == 'lb' || $('#empresa_lista').val() == 'ln') {
            //
            //                    if ($('#empresa_googleMap_address').val() == '') {
            //                        alert('Para publicar una empresa/entidad en la lista blanca necesitas asociarle una ubicación.');
            //                        $('#empresa_googleMap').addClass('errors');
            //                        validated = false;
            //                    }
            //                }
            //                if (validated) {
