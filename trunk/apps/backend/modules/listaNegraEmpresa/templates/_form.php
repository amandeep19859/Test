...
<div class="sf_admin_form">
    <?php echo form_tag_for($form, '@lista_negra_empresa', array('id' => 'form_empresa_lista_negra')) ?>
    ...
    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
        <?php include_partial('listaNegraEmpresa/form_fieldset', array('empresa' => $empresa, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
    <?php endforeach; ?>

    <?php include_partial('listaNegraEmpresa/form_actions', array('empresa' => $empresa, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
</form>
</div>
<style type="text/css">
