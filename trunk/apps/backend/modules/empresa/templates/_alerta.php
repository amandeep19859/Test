<li>
    <?php echo format_datetime($respuesta->getCreatedAt(), "HH:mm dd/MM/y", "es_ES")?>
    <strong><?php echo $respuesta->getEmpresa()?></strong>,
        <?php echo $respuesta->getEmpresa()->getMunicipioProvincia() ?>,
