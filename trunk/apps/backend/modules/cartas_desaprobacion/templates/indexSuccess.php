...
<div id="sf_admin_container">
    <h1><?php echo __('Listado de cartas de desaprobación', array(), 'messages') ?></h1>

    <?php include_partial('cartas_desaprobacion/flashes') ?>

    <div id="sf_admin_header">
        <?php include_partial('cartas_desaprobacion/list_header', array('pager' => $pager)) ?>
    </div>
    ...
    <div id="sf_admin_bar" class="filters_center" style="float: none;margin: auto;width: 450px;<?php echo (count($filtershow) <= 1) ? 'display: none;' : ''; ?>">
        <?php include_partial('cartas_desaprobacion/filters', array('form' => $filters, 'configuration' => $configuration)) ?>
    </div>
    ...
    <div id="sf_admin_content">
        <form action="<?php echo url_for('profesional_letter_cartas_desaprobacion_collection', array('action' => 'batch')) ?>" method="post">
            <?php include_partial('cartas_desaprobacion/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper)) ?>
            <ul class="sf_admin_actions">
                <?php include_partial('cartas_desaprobacion/list_batch_actions', array('helper' => $helper)) ?>
                <?php include_partial('cartas_desaprobacion/list_actions', array('helper' => $helper)) ?>
            </ul>
        </form>
    </div>

    <div id="sf_admin_footer">
        <?php include_partial('cartas_desaprobacion/list_footer', array('pager' => $pager)) ?>
    </div>
</div>
