<div class="container">
  <?php foreach($compnay_audit_records as $index => $audit_record):?>
  <a class="l-audita" href="javascript:void(0)" data-company="<?php echo $audit_record['Empresa']['id']?>" data-id="<?php echo $audit_record['id']?>">
...
<script type="text/javascript">
  var url = "<?php echo '/company/auditaRecord/' ?>";
  ...
  $(document).ready(function(){
    ...
    $('.l-audita').bind('click', function(){
      ...
      $.ajax({
        url: url+ 'company/'+ company_id+'/id/'+audit_id,
