...
<div class="buscador">
    ...
    <div class="buscador-wrapper">
        ...
        <div class="content-middle">
            <form id='form_buscador' class="form-stacked" action="<?php echo url_for('@lista_negra_empresa') ?>" method="get">
                <input type="hidden" value="reset" name="reset" id="resetForm"/>
                <div class="basico">
                    ...
                    <div class="columna">
                        ...
                        <?php //echo $form['localidad_id']->render(array('style' => 'width:350px;')); ?>
                        <?php //echo $form['localidad_id']->render(array('style' => 'height:22px;')); ?>
                        <?php echo $form['localidad_id']->render(array('style' => 'width:245px;height:22px;')); ?>
                    </div>
                    <div class="botonera">
                        <input class='btn' type="submit" value="Buscar" title="Buscar empresas y entidades no recomendadas"/>
                        <a href="#" id='limpiar_filtro' title='Nueva búsqueda de empresas y entidades no recomendadas'>nueva búsqueda</a>
