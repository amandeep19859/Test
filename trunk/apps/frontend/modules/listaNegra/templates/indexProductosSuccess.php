<?php include_partial("listaBlanca/breadcrumb", array('sectoresActivos' => $sectoresActivos, 'lista' => '<strong>Lista negra de productos</strong>')) ?>
...
<div id="content_laslistas_lista">
    ...
    <div class="content-middle">
        ...
        <div id="content_laslistas_right">
            <div class="top">
                <div class="order">
                    <?php include_partial('ordenaProducto', array('sortForm' => $sortForm)); ?>
                </div>
            </div>
            <div id="content-results" class="main">
                ...
                <div class="middle">
                    ...
                    <div id='resultados_empresas'>
                        <?php include_partial('resultadosProducto', array('pager' => $pager, 'ms_values' => $ms_values, 'sectoresActivos' => $sectoresActivos)); ?>

                    </div>
                    <?php include_partial('global/black_board', array('section' => 'LNP')) ?>
                </div>
