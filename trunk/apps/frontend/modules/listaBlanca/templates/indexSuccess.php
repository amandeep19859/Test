<?php include_partial("breadcrumb", array('sectoresActivos' => $sectoresActivos, 'lista' => '<strong>Lista blanca de empresas y entidades</strong>')) ?>
            ...
            <div id="content-results" class="main">
                ...
                <div class="middle">
                    ...
                    <div id='resultados_empresas'>
                        <?php include_partial('resultadosEmpresa', array('pager' => $pager, 'empresasDestacadas' => $empresasDestacadas, 'buscandoPorSector' => $buscandoPorSector, 'ms_values' => $ms_values, 'sectoresActivos' => $sectoresActivos)); ?>
                    </div>
                    <?php include_partial('global/black_board', array('section' => 'LBE')) ?>
                </div>
