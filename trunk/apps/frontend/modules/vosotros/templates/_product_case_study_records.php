                ...
                <div style="float: left; width: 100%">
                    ...
                    <div style="float: left; width: 75%">
                        <?php if ($is_user_submitted): ?>
                            <?php if ($is_authenticated): ?>
                                <p class="rojo_marron" style="margin-top: 0"><strong><?php echo __('Creado por ') . ($product_record->getUserName() == $sf_user->getUsername() ? 'ti' : $product_record->getUserName()); ?></strong></p>
                            <?php else: ?>
                                <p class="rojo_marron" style="margin-top: 0"><strong><?php echo __('Creado por ') . $product_record->getUserName(); ?></strong></p>
                            <?php endif; ?>
                        <?php endif; ?>
                        <p class="rojo_marron" style="<?php echo (!$is_user_submitted) ? "margin-top: 0" : ""; ?>">
                    ...
                    <div style="float: right; width: 25%">
                        <div style="margin-left: 53px; position: absolute;">
                            <?php if (!$product_record->getLogo() && !file_exists("images/uploads/documents/" . $product_record->getLogo())): ?>
                                <div style="height: <?php echo ($product_record->getLogo() && file_exists("images/uploads/documents/" . $product_record->getLogo())) ? '68px' : '5px'; ?>">&nbsp;</div>
                            <?php endif; ?>
