                ...
                <div style="float: left; width: 100%">
                    ...
                    <div style="float: left; width: 75%; margin-top: -3px;">
                        <?php if ($submenu_type == "user_case_study"): ?>
                            <?php if ($is_authenticated): ?>
                                <p class="rojo_marron"><strong><?php echo __('Creado por ') . ($company_record->getUserName() == $sf_user->getUsername() ? 'ti' : $company_record->getUserName()); ?></strong></p>
                            <?php else: ?>
                                <p class="rojo_marron"><strong><?php echo __('Creado por ') . $company_record->getUserName(); ?></strong></p>
                            <?php endif; ?>
                        <?php endif; ?>
                        <p class="azul">
                    ...
                    <div style="float: right; width: 25%">
                        <div style="margin-left: 53px; position: absolute;">
                            ...
                            <?php if (!$company_record->getLogo() && !file_exists("images/uploads/documents/" . $company_record->getLogo())): ?>
                                <div style="height: <?php echo ($sector_image && file_exists("images/uploads/documents/" . $sector_image)) ? '65px' : '4px'; ?>">&nbsp;</div>
                            <?php endif; ?>
