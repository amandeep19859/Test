                ...
                <div style="float: left; width: 100%">
                    ...
                    <div style="float: left; width: 75%">
                        <?php if ($submenu_type == 'user_case_study'): ?>
                            <?php if ($is_authenticated): ?>
                                <p class="rojo_marron" style="margin-top: 0">
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <p class="rojo_marron" style="<?php echo ($submenu_type != 'user_case_study') ? "margin-top: 0" : ""; ?>">
                    ...
                    <div style="float: right; width: 25%">
                        <div style="margin-left: 53px; position: absolute;">
                            <?php if (!$product_record->getLogo() && !file_exists("images/uploads/documents/" . $product_record->getLogo())): ?>
                                <div style="height: <?php echo ($product_record->getLogo() && file_exists("images/uploads/documents/" . $product_record->getLogo())) ? '65px' : '3px'; ?>">&nbsp;</div>
                            <?php endif; ?>
