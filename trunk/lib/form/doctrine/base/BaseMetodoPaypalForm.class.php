...
/**
 * MetodoPaypal form base class.
 *
 * @method MetodoPaypal getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseMetodoPaypalForm extends BaseFormDoctrine {
    ...
    public function setup() {
        ...
        $this->widgetSchema->setNameFormat('metodo_paypal[%s]');
