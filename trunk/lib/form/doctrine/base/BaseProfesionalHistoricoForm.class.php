...
/**
 * ProfesionalHistorico form base class.
 *
 * @method ProfesionalHistorico getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseProfesionalHistoricoForm extends BaseFormDoctrine {
    ...
    public function setup() {
        ...
        $this->widgetSchema->setNameFormat('profesional_historico[%s]');
