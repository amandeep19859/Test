...
/**
 * UserCompanyCaseStudy form base class.
 *
 * @method UserCompanyCaseStudy getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseUserCompanyCaseStudyForm extends BaseFormDoctrine {
    ...
    public function setup() {
        ...
        $this->widgetSchema->setNameFormat('user_company_case_study[%s]');
