...
/**
 * EmpresaSectorDos form base class.
 *
 * @method EmpresaSectorDos getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseEmpresaSectorDosForm extends BaseFormDoctrine {
    ...
    public function setup() {
        ...
        $this->validatorSchema->setPostValidator(
                new sfValidatorDoctrineUnique(array('model' => 'EmpresaSectorDos', 'column' => array('slug', 'id', 'name')))
        );

        $this->widgetSchema->setNameFormat('empresa_sector_dos[%s]');
