...
/**
 * AdministrationEmails form base class.
 *
 * @method AdministrationEmails getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseAdministrationEmailsForm extends BaseFormDoctrine {
    ...
    public function setup() {
        ...
        $this->widgetSchema->setNameFormat('administration_emails[%s]');
