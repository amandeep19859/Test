...
/**
 * ProductoTipoDos form base class.
 *
 * @method ProductoTipoDos getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseProductoTipoDosForm extends BaseFormDoctrine {
    ...
    public function setup() {
        ...
        $this->validatorSchema->setPostValidator(
                new sfValidatorDoctrineUnique(array('model' => 'ProductoTipoDos', 'column' => array('slug', 'id', 'name')))
        );

        $this->widgetSchema->setNameFormat('producto_tipo_dos[%s]');
