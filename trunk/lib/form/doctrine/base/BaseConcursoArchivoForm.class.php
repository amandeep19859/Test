...
/**
 * ConcursoArchivo form base class.
 *
 * @method ConcursoArchivo getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseConcursoArchivoForm extends BaseFormDoctrine {
    ...
    public function setup() {
        ...
        $this->widgetSchema->setNameFormat('concurso_archivo[%s]');
