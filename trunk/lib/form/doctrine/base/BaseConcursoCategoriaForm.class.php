...
/**
 * ConcursoCategoria form base class.
 *
 * @method ConcursoCategoria getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseConcursoCategoriaForm extends BaseFormDoctrine {
    ...
    public function setup() {
        ...
        $this->widgetSchema->setNameFormat('concurso_categoria[%s]');
