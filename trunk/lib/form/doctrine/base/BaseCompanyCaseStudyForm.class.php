...
/**
 * CompanyCaseStudy form base class.
 *
 * @method CompanyCaseStudy getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseCompanyCaseStudyForm extends BaseFormDoctrine {
