...
/**
 * UserProductCaseStudy form base class.
 *
 * @method UserProductCaseStudy getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseUserProductCaseStudyForm extends BaseFormDoctrine {
    ...
    public function setup() {
        ...
        $this->widgetSchema->setNameFormat('user_product_case_study[%s]');
