...
class ProfesionalSearchForm extends BaseForm {
    public function configure()
    {   echo "ProfesionalSearchForm";exit;
  	parent::configure();
  	...
  	$this->widgetSchema['states_id'] = new sfWidgetFormDoctrineChoice(array('model'=>'States','table_method' => 'getWithTodas','add_empty' => 'Selecciona provincia', 'order_by' => array('orden', 'asc')));
    ...
    public function processForm($request)
    {
        ...
        $userData = array();
        if ($request->isMethod('GET') or $extra == 'restore')
        {
