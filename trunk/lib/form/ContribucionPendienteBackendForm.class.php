...
class ContribucionPendienteBackendForm extends ContribucionFormUno {
    ...
    public function configure() {
        ...
        $this->widgetSchema['concurso_id'] = new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Concurso'), 'add_empty' => false, 'order_by' => array('id', 'desc'), 'query' => $q));
        ...
        $this->validatorSchema["incidencia"] = new sfValidatorString(
                        array('required' => true), array(
                    'required' => 'No has incluido la descripción de la incidencia.'));
