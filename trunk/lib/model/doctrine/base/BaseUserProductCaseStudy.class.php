 ...
 * @method UserProductCaseStudy setStatus()                Sets the current record's "status" value
 * @method UserProductCaseStudy setUserName()              Sets the current record's "user_name" value
 * @method UserProductCaseStudy setUserId()                Sets the current record's "user_id" value
 * @method UserProductCaseStudy setName()                  Sets the current record's "name" value
 * @method UserProductCaseStudy setMarca()                 Sets the current record's "marca" value
 * @method UserProductCaseStudy setModelo()                Sets the current record's "modelo" value
 * @method UserProductCaseStudy setProductoTipoUnoId()     Sets the current record's "producto_tipo_uno_id" value
 * @method UserProductCaseStudy setProductoTipoDosId()     Sets the current record's "producto_tipo_dos_id" value
 * @method UserProductCaseStudy setProductoTipoTresId()    Sets the current record's "producto_tipo_tres_id" value
 * @method UserProductCaseStudy setDescription()           Sets the current record's "description" value
 * @method UserProductCaseStudy setSummary()               Sets the current record's "summary" value
 * @method UserProductCaseStudy setFile1()                 Sets the current record's "file1" value
 * @method UserProductCaseStudy setFile2()                 Sets the current record's "file2" value
 * @method UserProductCaseStudy setFile3()                 Sets the current record's "file3" value
 * @method UserProductCaseStudy setFile4()                 Sets the current record's "file4" value
 * @method UserProductCaseStudy setLogo()                  Sets the current record's "logo" value
 * @method UserProductCaseStudy setUser()                  Sets the current record's "User" value
 * @method UserProductCaseStudy setProductoTipoUno()       Sets the current record's "ProductoTipoUno" value
 * @method UserProductCaseStudy setProductoTipoDos()       Sets the current record's "ProductoTipoDos" value
 * @method UserProductCaseStudy setProductoTipoTres()      Sets the current record's "ProductoTipoTres" value
 * 
 * @package    symfony
 * @subpackage model
 ...
 */
abstract class BaseUserProductCaseStudy extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('user_product_case_study');
