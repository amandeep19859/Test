 ...
 * @method EmpresaSectorDos    setName()                        Sets the current record's "name" value
 * @method EmpresaSectorDos    setValue()                       Sets the current record's "value" value
 * @method EmpresaSectorDos    setOrden()                       Sets the current record's "orden" value
 * @method EmpresaSectorDos    setImage()                       Sets the current record's "image" value
 * @method EmpresaSectorDos    setEmpresaSectorUnoId()          Sets the current record's "empresa_sector_uno_id" value
 * @method EmpresaSectorDos    setEmpresaSectorUno()            Sets the current record's "EmpresaSectorUno" value
 * @method EmpresaSectorDos    setEmpresaSectorTres()           Sets the current record's "EmpresaSectorTres" collection
 * @method EmpresaSectorDos    setEmpresa()                     Sets the current record's "Empresa" collection
 * @method EmpresaSectorDos    setEmpresasDestacadas()          Sets the current record's "EmpresasDestacadas" collection
 * @method EmpresaSectorDos    setCompanyCaseStudy()            Sets the current record's "CompanyCaseStudy" collection
 * @method EmpresaSectorDos    setUserCompanyCaseStudy()        Sets the current record's "UserCompanyCaseStudy" collection
 * @method EmpresaSectorDos    setUserCompanyCaseStudyRequest() Sets the current record's "UserCompanyCaseStudyRequest" collection
 * @method EmpresaSectorDos    setListaCuestionario()           Sets the current record's "ListaCuestionario" collection
 * 
 * @package    symfony
 * @subpackage model
 ...
 */
abstract class BaseEmpresaSectorDos extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('empresa_sector_dos');
