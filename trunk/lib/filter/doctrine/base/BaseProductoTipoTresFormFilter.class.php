...
/**
 * ProductoTipoTres filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseProductoTipoTresFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('producto_tipo_tres_filters[%s]');
