...
/**
 * ConcursoHistorico filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseConcursoHistoricoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('concurso_historico_filters[%s]');
