...
/**
 * ProductCaseStudy filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseProductCaseStudyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('product_case_study_filters[%s]');
