...
/**
 * ProfesionalTipoTres filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseProfesionalTipoTresFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('profesional_tipo_tres_filters[%s]');
