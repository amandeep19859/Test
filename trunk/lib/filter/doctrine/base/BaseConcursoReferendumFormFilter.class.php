...
/**
 * ConcursoReferendum filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseConcursoReferendumFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('concurso_referendum_filters[%s]');
