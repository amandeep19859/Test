...
/**
 * GanadoresConcursos filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseGanadoresConcursosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ganadores_concursos_filters[%s]');
