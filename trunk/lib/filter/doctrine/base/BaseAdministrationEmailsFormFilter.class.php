...
/**
 * AdministrationEmails filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseAdministrationEmailsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('administration_emails_filters[%s]');
