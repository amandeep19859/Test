...
/**
 * EmpresaSectorDos filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseEmpresaSectorDosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('empresa_sector_dos_filters[%s]');
