...
/**
 * ProfesionalHistorico filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseProfesionalHistoricoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('profesional_historico_filters[%s]');
