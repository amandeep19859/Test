...
/**
 * ComentarioConcurso filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseComentarioConcursoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('comentario_concurso_filters[%s]');
