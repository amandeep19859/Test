...
/**
 * ListaCuestionarioUser filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseListaCuestionarioUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lista_cuestionario_user_filters[%s]');
