...
/**
 * UserProductCaseStudy filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseUserProductCaseStudyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('user_product_case_study_filters[%s]');
