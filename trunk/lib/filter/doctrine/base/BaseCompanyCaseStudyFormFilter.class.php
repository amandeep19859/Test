...
/**
 * CompanyCaseStudy filter form base class.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
abstract class BaseCompanyCaseStudyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('company_case_study_filters[%s]');
