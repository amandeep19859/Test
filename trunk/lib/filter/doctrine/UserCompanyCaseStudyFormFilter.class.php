...
/**
 * UserCompanyCaseStudy filter form.
 *
 * @package    symfony
 * @subpackage filter
 ...
 */
class UserCompanyCaseStudyFormFilter extends BaseUserCompanyCaseStudyFormFilter
{
  public function configure()
  {
    ...
    $this->widgetSchema['user_name'] = new sfWidgetFormFilterInput(array('with_empty' => false), array('maxlength' => 25, 'style' => 'width:176px;'));
    ...
    $this->widgetSchema['status'] = new sfWidgetFormChoice(array('choices' => array('1' => 'Revista', '2' => 'Tramitado', '3' => 'Cerrado'), 'label'=>'Estado'));
