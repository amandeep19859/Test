 ...
 */
class ListaNegraEmpresaFormFilter extends BaseEmpresaFormFilter
{
    public function configure()
    {
        ...
        $this->useFields(array('name', 'states_id', 'localidad_id', 'empresa_sector_uno_id', 'empresa_sector_dos_id',
