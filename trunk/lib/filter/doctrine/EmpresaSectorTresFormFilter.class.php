 ...
 */
class EmpresaSectorTresFormFilter extends BaseEmpresaSectorTresFormFilter
{
  public function configure()
  {
	$i18n = sfContext::getInstance()->getI18N();
        ...
        $this->widgetSchema['empresa_sector_uno_id'] = new sfWidgetFormDoctrineDependentSelect(array('model' => $this->getRelatedModelName('EmpresaSectorUno'), 'add_empty' => 'Selecciona sector'));
